...
public class RegistarCliente extends javax.swing.JFrame {
    ...
    private void btnRegistarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistarActionPerformed
        ...
        if (txtNome == null || txtNomeText.length() <2|| !txtNomeText.matches("^[a-zA-Z\\s]+$")){
            throwMessageError("Nome inválido. O nome deve conter pelo menos 2 carateres não-brancos e apenas caracteres");
            erro=true;
        }
        //Validar  Telefone
        ...
        if(!erro) {
            ...
            if(DadosAplicacao.INSTANCE.adicionarCliente(cliente)){
                setVisible(false);
                dispose();
                return;
            }
            throwMessageError("Cliente. O cliente inserido já esta na lista de clientes");
        }
