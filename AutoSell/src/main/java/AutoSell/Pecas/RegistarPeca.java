...
public class RegistarPeca extends javax.swing.JFrame {
    ...
    private void btnRegistarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistarActionPerformed
        ...
        if(!erro) {
            Peca peca = new Peca(txtNomeText,txtRefText,txtMarcaText,quantidade,destino1.getSelectedItem()+"/"+destino2.getSelectedItem(),veiculoMarca.getSelectedItem()+"/"+veiculoModelo.getSelectedItem());
