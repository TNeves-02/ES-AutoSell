...
public class RegistarFilial extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Registar Filial");
    ...
    private void btnRegistarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistarActionPerformed
        ...
        if(!erro) {
            ...
            if(DadosAplicacao.INSTANCE.adicionarFilial(filial)){
                setVisible(false);
                dispose();
                return;
            }
            throwMessageError(" Filial. A filial inserida já esta na lista de Filiais");
        }
